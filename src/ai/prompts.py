...
def resume_user_prompt(
    ...
    return (
        ...
        "a shorter bullet, drop trailing detail and place it lower in the "
        "section. Demotion is allowed - deletion is never allowed at this "
        "stage. Deletion is the user's decision and a confirmation dialog "
        "will ask them explicitly before anything is removed from the "
        "exported resume.\n"
